...
if($action == 'about_login'){
    include('../login_view/about_login.php');
}

if($action == 'travel_login'){
    $action = NULL;
    ...
    include ('../login_view/travel_login.php');
}

if($action == 'contact_login'){
    include '../login_view/contact_login.php';
}
    ...
    if ($tripID == NULL || $tripID == FALSE) {
        ...
        include('../login_view/trip_edit.php');
    }
}
